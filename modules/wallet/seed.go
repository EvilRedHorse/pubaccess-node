...
// globalTimelock is time lock used for all addresses generated by this binary.
// Changing globalTimelock changes all addresses generated with this seed,
// so it is recommended to make a separate seed and spd installation for this.
const globalTimelock = 0

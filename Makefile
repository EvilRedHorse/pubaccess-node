...
ldflags= -X github.com/EvilRedHorse/pubaccess-node/build.GitRevision=${GIT_DIRTY}${GIT_REVISION} \
-X "github.com/EvilRedHorse/pubaccess-node/build.BuildTime=${BUILD_TIME}"
